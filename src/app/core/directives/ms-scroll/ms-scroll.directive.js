(function ()
{
    ...
    /** @ngInject */
    function msScrollDirective($timeout, msScrollConfig, msUtils, scaffolderConfig)
    {
        return {
            restrict: 'AE',
            compile : function (tElement)
            {
                ...
                if ( scaffolderConfig.getConfig('disableCustomScrollbars') )
                {
                    return;
                }
                ...
                if ( scaffolderConfig.getConfig('disableCustomScrollbarsOnMobile') && msUtils.isMobile() )
                {
                    return;
                }
