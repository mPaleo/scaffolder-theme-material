(function ()
{
    ...
    angular
        .module('app.core')
        .factory('scaffolderGenerator', scaffolderGeneratorService);

    /** @ngInject */
    function scaffolderGeneratorService($cookies, $log, scaffolderTheming)
    {
        ...
        function generate()
        {
            var registeredThemes = scaffolderTheming.getRegisteredThemes();
            var registeredPalettes = scaffolderTheming.getRegisteredPalettes();
        ...
        function processAndStoreThemes(_themes)
        {
            ...
            scaffolderTheming.setThemesList(themes);
            ...
            if ( selectedTheme )
            {
                scaffolderTheming.setActiveTheme(selectedTheme);
            }
            else
            {
                scaffolderTheming.setActiveTheme('scaffolder');
            }
        }
